...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(alphabeticRow("abcdjuwxbcde"));
        System.out.println(alphabeticRow("klmabzyxw"));

        System.out.println("----------5");
        System.out.println(charactersCounter("aaa"));
    ...
    private static void generateCombinations(String current, int n, ArrayList<String> result) {
        ...
        // Добавляем "1" к текущей последовательности и рекурсивно вызываем функцию

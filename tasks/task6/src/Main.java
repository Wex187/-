...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(collect("strengths", 2)));
        ...
        System.out.println(generateNonconsecutive("10 * 16 + 5"));
        System.out.println(generateNonconsecutive("6 * (2 - (8 * 5 - 30))"));
